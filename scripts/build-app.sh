...
# Launcher script
cp "$ROOT/scripts/app/mstack-browser" "$APP_DIR/Contents/MacOS/mstack-browser"
chmod +x "$APP_DIR/Contents/MacOS/mstack-browser"
...
echo "    Contents/MacOS/mstack-browser     (launcher)"
