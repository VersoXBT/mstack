...
version: 1.0.0
description: |
  Ideal customer profile builder. Generates 2-3 detailed buyer personas using the
...
> 3. Is this primarily B2B, B2C, or mixed?
> 4. Do you have any existing customer data? (industry, titles, company sizes, revenue ranges)"
...
**Goals**
1. {Functional goal: the concrete outcome they're paid or motivated to achieve}
2. {Growth goal: how they want their situation to improve over the next 12 months}
3. {Career or personal aspiration that shapes how they evaluate tools and decisions}

**Pain Points**
1. {Primary pain — the specific failure mode that keeps them up at night, with concrete stakes}
