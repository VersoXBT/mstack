...
version: 1.0.0
description: |
  Proof and customer story workflow. Turns raw wins, testimonials, usage data,
  sales notes, or interview transcripts into proof assets: case studies, quote banks,
  landing-page proof blocks, objection-specific evidence, and social proof snippets.
  Use when asked for testimonials, case studies, customer stories, proof, or credibility.
allowed-tools:
  - Bash
  - Read
  - Write
